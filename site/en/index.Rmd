...
The goal of this [dashboard](https://favstats.github.io/vaccc19de_dashboard/en) is to document and visualize the progress of COVID-19 vaccinations in Germany.

The vaccination data is provided by the [Robert Koch Institute (RKI)](https://www.rki.de/DE/Content/InfAZ/N/Neuartiges_Coronavirus/Daten/Impfquoten-Tab.html). The data presented here was processed with the help of the R package [vaccc19de](https://github.com/friep/vaccc19de).

Population data for the federal states is taken from the [Federal Statistics Office (Statistisches Bundesamt)](https://www.destatis.de/DE/Themen/Gesellschaft-Umwelt/Bevoelkerung/Bevoelkerungsstand/Tabellen/bevoelkerung-nichtdeutsch-laender.html).

> Note: The RKI does not (yet) differentiate between first and second vaccination in its data.
...
df <- data.frame(
    ...
    value = c(geimpft,
             ...
             geimpft_lasttime,
             prozent_lasttime),
    info = c("Total Vaccinations",
             "Vaccine doses per 100 Inhabitants",
             glue::glue("Vaccines administered (since {latest_day})"),
             glue::glue("Percent growth (since {latest_day})")),
...
![](https://github.com/favstats/vaccc19de_dashboard/blob/display-notes/img/infobox1_en.png?raw=true)
![](https://github.com/favstats/vaccc19de_dashboard/blob/display-notes/img/infobox2_en.png?raw=true)
