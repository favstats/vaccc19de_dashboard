...
The goal of this [dashboard](https://favstats.github.io/vaccc19de_dashboard/) is to document and visualize the progress of COVID-19 vaccinations in Germany.

The vaccination data is provided by the [Robert Koch Institute (RKI)](https://www.rki.de/DE/Content/InfAZ/N/Neuartiges_Coronavirus/Daten/Impfquoten-Tab.html). The data presented here was retrieved with the help of the R package [vaccc19de](https://github.com/friep/vaccc19de) and can be accessed [here](https://github.com/friep/vaccc19de_rki_data).
...
Author: [Fabio Votta](https://github.com/favstats)
...
infobox1 <- df %>% 
  ...
  ggplot(aes(x, y, height = h, width = w, label = info)) +
    ...
    geom_text(size = 25, aes(label = shape, family = font_family,
